...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "source_id",
            sa.String(64),
            sa.ForeignKey("data_source.source_id", name="fk_drift_log_source"),
            nullable=False,
            comment="数据源标识",
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "source_id",
            sa.String(64),
            sa.ForeignKey("data_source.source_id", name="fk_watermark_source"),
            nullable=False,
            unique=True,
            comment="数据源标识（唯一）",
        ),
    ...
    op.alter_column(
        ...
        type_=sa.Enum(
            "PUBLIC", "INTERNAL", "CONFIDENTIAL", "PII", "NEEDS_REVIEW", name="sensitivity_enum"
        ),
        existing_nullable=False,
    )
